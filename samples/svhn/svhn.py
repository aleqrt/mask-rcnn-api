...
class SVHNDataset(utils.Dataset):
    ...
    def load_svhn(self, label_file_path, annotation_dir, images_dir):
    ...
    def load_mask(self, image_id):
        ...
        """
        # If not a svhn dataset image, delegate to parent class.
...
class SVHNConfig(Config):
    """Configuration for training on the SVHN dataset.
    ...
    NUM_CLASSES = 1 + 10  # background + 10 numbers
...
class SVHNInferenceConfig(SVHNConfig):
    GPU_COUNT = 1
    IMAGES_PER_GPU = 1
