...
def main(input_folder, output_folder):
    ...
    for asset_name in asset_names:
        ...
        for img in assets:
            ...
            # TODO: Replace REPLACE_WITH_ACTUAL_PATH with the actual dataset folder name before use
            images_path = 'dataset/elettrocablaggi/REPLACE_WITH_ACTUAL_PATH/images/'
